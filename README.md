...
All website files are in [website](website/). See the [setup and deployment instructions](website/README.md).

Run commands from the website folder:

    cd website
    npm install
    npm run dev

For Vercel, set the project Root Directory to `website`.
