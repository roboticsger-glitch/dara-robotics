...
export function QuoteForm({ product = "" }: { product?: string }) {
  ...
  return (
    <form className="form-card" onSubmit={submit}>
      ...
      <div className="form-grid two"><label>Business email<input name="email" required type="email" placeholder="name@company.com" /></label><label>Phone / WhatsApp<input name="phone" required placeholder="Include country code" /></label></div>
      ...
      <label>Tell us about the site or task<textarea name="message" required rows={5} placeholder="Example: 12,000 m² warehouse. We want to automate floor cleaning and need local maintenance support." /></label>
